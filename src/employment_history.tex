...
\vspace{\CVItemizeHeaderSpacing} \begin{itemize}[leftmargin=*, rightmargin=1cm]
	...
	%\item Erstellung einer GUI mit QT-Backend zur Konfiguration von Hyperparametern für verschiedene C++-Punktwolkenfilter.
	\item Erstellung ein GUI mit Qt Backend für die Konfiguration von Punktwolkenfiltern und Interaktion mit der REST-API des eingebetteten Systems
\end{itemize}
%
% CE
%
