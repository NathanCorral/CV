...
\vspace{\CVItemizeHeaderSpacing} \begin{itemize} % Adjust the value as needed
	...
	%\item Supported scientific research in personalized robot navigation by contributing to two publications. 
	
	%%%%% UNCOMMENT FOR ROBOTICS POSTION
	...
	%%%%% UNCOMMENT FOR GENERAL AI / DeepL
	%\item Presented a seminar on .....
	%\item Programmed the interface to the iGibson simulator for automatic data collection.  Using this program, we were able to generate a multi-modal dataset of over 50 GB.  
	%%%%% UNCOMMENT FOR ABB
	%\item Presented a seminar on techniques for low-resource Computer Vision.
	%\item ...
	%\item ..
	%\item .
	
\end{itemize}
%\vspace*{-6mm} % Before an entry
