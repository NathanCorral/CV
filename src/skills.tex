...
\entry*[Languages]
	\skilldotfirst English (Native) \skilldot Deutsch (C1)
\entry*[Stärken] 
	\skilldotfirst Problemlösung \skilldot Zusammenarbeit \skilldot Zuverlässig \newline \skilldotfirst Technische Dokumentation \skilldot Fleißig % \skilldot Positive Attitude  \skilldot Protoype Development 
\entry*[Coding]
...
\entry*[Wissen] 	
	\skilldotfirst Agile \skilldot REST API \skilldot Test-driven Development \skilldot POSIX  \newline \skilldotfirst Object Oriented Programming \skilldot Data Structures \skilldot DevOps \skilldot SQL
%\entry*[Robotics]
