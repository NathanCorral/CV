...
\vspace{\CVItemizeHeaderSpacing} \begin{itemize}[leftmargin=*, rightmargin=1cm] 
	...
	\item Ich führe Web-Scraping, Datensatz Einbettung (unter Apache Arrow) und Ähnlichkeitsbewertung durch, um Dateneinträge basierend auf einer Abfrage in natürlicher Sprache abzurufen.
\end{itemize}  
\begin{comment}
