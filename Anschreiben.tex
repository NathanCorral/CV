...
\begin{document}
	...
	\makelettertitle
	Mit großem Interesse habe ich die Stellenausschreibung für die Position als Embedded Software Engineer bei Safran gelesen. Die Möglichkeit, in einem hochspezialisierten Team an innovativen Messgeräten zu arbeiten, fasziniert mich, und ich bin überzeugt, dass meine Erfahrung und meine Fähigkeiten einen wertvollen Beitrag leisten können.
	...
	Meine Erfahrung in der Embedded-Programmierung konnte ich bei Head Rush Technologies weiter vertiefen. Dort war ich für die Entwicklung der Firmware eines maßgeschneiderten PCBs verantwortlich. Die Software sollte die Geschwindigkeit eines Kletterers messen, indem ein Zahnrad-Sensor Interrupts auslöste, sobald sich die Person entlang der Kletterwand bewegte. Trotz der vergleichsweise einfachen Funktionsweise im Vergleich zu den digitalen Geschwindigkeitssensoren von Safran konnte das System erfolgreich als Prototyp eingesetzt werden und war genau genug, um Stürze zu erkennen. Nach erfolgreich durchgeführten Feldtests habe ich die Codebasis sowie die zugehörige Dokumentation an das Unternehmen übergeben. Dabei habe ich meine Kenntnisse in Embedded C, Firmware-Flashing für individuelle PCB-Geräte und die interdisziplinäre Zusammenarbeit mit verschiedenen Teams weiter ausgebaut.
	
	Mit meinem Umzug nach Deutschland für meinen Master in Informatik habe ich mein Wissen in der Softwareentwicklung weiter vertieft und wertvolle Techniken zur Verarbeitung von Messdaten erlernt – beispielsweise Sensorfusion mittels Kalman-Filtern. Während meiner Tätigkeit im Humanoid Robots Lab konnte ich zudem praktische Erfahrung mit GitLab CI/CD, CMake-Build-Systemen und der Implementierung von Software auf autonomen Robotersystemen sammeln.
	
	Nach meinem Studium habe ich aktiv an einem Open-Source-Projekt mitgearbeitet und eine neue Streaming-Audio-Transkriptionsfunktion entwickelt, die zur Veröffentlichung von Version 1.4 führte. Dabei habe ich modernen C++-Code mit Fokus auf Multithreading, Effizienz und Skalierbarkeit geschrieben und die Software erfolgreich auf einem Nvidia Jetson Orin NX deployed.
	
	Es wäre mir eine große Ehre, meine Fähigkeiten in einem Unternehmen wie Safran einzusetzen, das an der Spitze der digitalen Hochgeschwindigkeitsdatenerfassung und -verarbeitung steht. Besonders die enge Zusammenarbeit mit der Hardware-Entwicklung und die Firmware-Programmierung für Embedded-Linux-Systeme sprechen mich an, da sie genau meinen bisherigen Erfahrungen und Interessen entsprechen.
	
	Gerne stehe ich für ein Gespräch zur Verfügung, um zu besprechen, wie ich mit meinem technischen Wissen, meiner engagierten Arbeitsweise und meiner Erfahrung in der Embedded-Entwicklung zum Team von Safran beitragen kann. Ich freue mich darauf, von Dir zu hören!
