...
\begin{document}
	...
	\makelettertitle
Sehr geehrtes exofarer-Team, 

Ich bewerbe mich mit großem Interesse auf die Position als Artificial Intelligence (AI) Engineer für eure Submarke exofarer. Mein Profil passt hervorragend zu euren Anforderungen:
  - Fundiertes theoretisches KI-Wissen: Mein Masterstudium in Informatik an der Universität Bonn schloss ich mit einer Thesis über stochastische Transformer für Videovorhersagen ab. Dabei nutzte ich Python und PyTorch für die Implementierung.
  - Praktische Erfahrung: Bei Head Rush Technologies entwickelte ich ein Proof-of-Concept-System und führte Nutzerstudien mit VR-Headsets durch. Die gewonnenen Daten nutzte ich für das Training von Deep-Reinforcement-Learning-Modellen.
  - Persönliche KI-Projekte: Ich erstellte eine Computer-Vision-Pipeline, die mehrere State-of-the-Art-Modelle parallel hostet, sowie eine semantische Suchmaschine für Github-Issues des Hugging Face Repositories unter Verwendung von FAISS und Apache Arrow.

Meine Kombination aus theoretischem Wissen und praktischer Erfahrung ermöglicht es mir, innovative KI-Lösungen zu entwickeln und zu implementieren. Ich würde mich freuen, meine Fähigkeiten bei exofarer einzubringen und zu eurem Erfolg beizutragen. 
